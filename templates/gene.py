...
def getGenePic(choose_time=2023,style="pixel"):
    ...
    answers = stability_api.generate(
        ...
        prompt=f"Create an image in a {image_style} style that represents a scene frozen in time in the year {year}. The image should maintain the original content, including the exact positions of objects and the overall composition. The only change should be the transformation of the photo into a {image_style} representation, reflecting the distinctive aesthetic of {image_style} visuals. The scene is set in {year}, so any visible technology, fashion, or environmental elements should subtly indicate this year, but without altering the fundamental elements of the original photo",
        init_image = img,
